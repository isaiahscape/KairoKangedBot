...
nations = """ Kairo's Son has bot access levels we call as *"Nation Levels"*
...
Owner has complete bot access, including bot adminship in chats Kairo is at.
\n*Royals* - Have super user access, can gban, manage Nations lower than them and are admins in Kigyō.
\n*Sakuras* - Have access go globally ban users across Kairo's.
...
Report abuse or ask us more on these at [Eagle Union](https://t.me/KairoBotSupport).
"""
