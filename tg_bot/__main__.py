                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url=f"https://t.me/KairoBotSupport",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/KairoButUpdates",
                            ),
                            InlineKeyboardButton(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/KairoBotUpdates",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "src_btn"),
                                url="https://github.com/Dank-del/EnterpriseALRobot",
    ...
    try:
        if mod_match:
            ...
            help_buttons.append(
                ...
                InlineKeyboardButton(text='Support', url='https://t.me/KairoBotSupport')]
            )
            ...
            kb.append([InlineKeyboardButton(text='Support', url='https://t.me/KairoBotSupport'),
            InlineKeyboardButton(text='Back', callback_data='start_back'), InlineKeyboardButton(text="Try inline", switch_inline_query_current_chat="")])
            query.message.edit_text(
